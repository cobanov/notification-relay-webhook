...
/**
 * Posts a JSON payload to all enabled webhooks in parallel with retry/backoff,
 * and records a [WebhookLog] for each attempt. Ported from the health-connect-webhook
 * project; the only domain-specific field is [sourcePackage] (the notification's app).
 */
class WebhookManager(
    private val webhookConfigs: List<WebhookConfig>,
    private val context: Context? = null,
    private val sourcePackage: String? = null,
